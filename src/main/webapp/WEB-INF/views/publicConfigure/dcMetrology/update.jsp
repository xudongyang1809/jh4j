...
<form id="form" method="post" action="${ctx}/dcMetrology/update" class="layui-form" style="margin:10px 10px;" onsubmit="return dialogAjaxDone(this);">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="margin-left:150px;">			
			<input type="text" name="strName" class="layui-input" lay-verify="required" value="${dcMetrologyDM.strName }" placeholder="请输入计量单位名称"/>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="margin-left:150px;">
			<input type="text" name="strSymbol" class="layui-input" value="${dcMetrologyDM.strSymbol }" placeholder="请输入计量单位符号"/>			
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="margin-left:150px;">			
			<input type="text" name="bdScale" class="layui-input" lay-verify="required|number" value="${dcMetrologyDM.bdScale}" placeholder="请输入换算比例"/>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="margin-left:150px;">			
			<input type="checkbox" name="isBasic" id="metro_isBasic" ${dcMetrologyDM.isBasic eq 'Y' ? 'checked':''} lay-ignore style="margin-top:15px;"/> <!-- onclick="checkMetroBaiscExist_Create(this)"/> -->
		</div>
	</div>
		
	<div class="layui-form-item" style="text-align:center;">
		<button class="layui-btn" type="submit">确定</button>
		<button class="layui-btn layui-btn-primary" type="button" onclick="closeThisDialog('dcMetrologyUpdate')">关闭</button>
	</div>
</form>
