...
<form class="layui-form" method="post" action="${ctx}/smTestFileUpload/create" enctype="multipart/form-data" onsubmit="return iframeCallback(this, 'create');">
 		...
 		<div class="layui-form-item">
	  	...
	  	<div class="layui-form-item">
	    	...
	    	<div class="layui-input-inline">
	      		<input type="text" name="intPriority" lay-verify="required" value="99" placeholder="请输入优先级" autocomplete="off" class="layui-input">
	    	</div>
